...
class MovieDataSource(private val webService: WebService) {
    ...
    suspend fun getUpcomingMovies(): MovieList {
        return webService.getUpcomingMovies(AppConstants.API_KEY, AppConstants.API_LANGUAGE)
    }

    suspend fun getTopRatedMovies(): MovieList = webService.getTopRatedMovies(AppConstants.API_KEY, AppConstants.API_LANGUAGE)
